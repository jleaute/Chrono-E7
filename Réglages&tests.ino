/*
Etalonnage de la tension et mesure de la valeur PPM
...
void setup() {
  ...
  lcd.print("Tension: ");                               // Ecran d'accueil
  ...
  lcd.print("%");
  delay(3000);                                          // Afficher l'écran d'accueil pendant 3 secondes
...
void loop() {
  ...
  lcd.setCursor(0, 1);
  lcd.print("    ");                                    // Effacer la précédente valeur PPM
  lcd.setCursor(0, 1);
  lcd.print(impulsCourant);                             // Affichage du signal PPM
